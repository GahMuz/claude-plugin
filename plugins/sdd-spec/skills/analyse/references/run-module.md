...
Si `.sdd/docs/modules/<module>/module-<module>.md` existe :
...
Agent({
  ...
  subagent_type: "sdd-spec:analyse-quality",
  prompt: "
    Module : <nom>
    Chemin : <path>
    Répertoire de sortie : .sdd/analyses/<nom>/
...
Agent({
  ...
  subagent_type: "sdd-spec:analyse-architecture",
  model: "opus",
  prompt: "
    Module : <nom>
    Chemin : <path>
...
Agent({
  ...
  subagent_type: "sdd-spec:analyse-compliance",
  prompt: "
    Module : <nom>
    Chemin : <path>
    Répertoire de sortie : .sdd/analyses/<nom>/
...
Écrire `.sdd/analyses/<module>/summary.md`.

## Step 7 : Mettre à jour le manifest

Lire `.sdd/analyses/manifest.json` (ou initialiser si absent).
...
Écrire `.sdd/analyses/manifest.json`.
...
## Fichiers générés
- .sdd/analyses/<module>/summary.md
- .sdd/analyses/<module>/quality.md
- .sdd/analyses/<module>/architecture.md
- .sdd/analyses/<module>/rgpd.md         (si applicable)
- .sdd/analyses/<module>/dora.md         (si applicable)
- .sdd/analyses/<module>/candidates.md   (si nouvelles règles)
```
