# Templates d'artifacts — plugin sdd-graph
...
```json
{
  ...
  "interfaces": [
    ...
    {
      "name": "PaymentGateway",
      "file": "src/main/java/com/acme/payment/PaymentGateway.java",
      "module": "payment",
      "extendsInterfaces": [],
      "implementors": [
        {
          "name": "StripePaymentGateway",
          "file": "src/main/java/com/acme/payment/StripePaymentGateway.java",
          "isAbstract": false
        },
        {
          "name": "MockPaymentGateway",
          "file": "src/main/java/com/acme/payment/MockPaymentGateway.java",
          "isAbstract": false
        }
      ]
    }
  ...
  "abstractClasses": [
    {
      ...
      "subclasses": [
        ...
        {
          "name": "Order",
          "file": "src/main/java/com/acme/order/domain/Order.java"
        }
      ]
    }
  ]
