...
1. Lire `<specPath>/requirement.md` — identifier le dernier REQ-xxx ID pour incrémenter
2. Lire `<specPath>/design.md` — contexte architectural pour orienter les critères d'acceptation
3. Glob `**/sdd-rules/SKILL.md` → exécuter le protocole de chargement — les règles orientent les critères non fonctionnels
...
```json
{ "date": "<ISO-8601>", "type": "requirements-update", "description": "X REQ ajoutés depuis revue", "addedItems": ["REQ-xxx", "REQ-yyy"] }
```
