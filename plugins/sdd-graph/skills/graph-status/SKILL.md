---
name: graph-status
description: "This skill should be used when the user invokes '/graph-status' to see which graphs are built, their freshness state, and coverage statistics. Reads .sdd/graph/manifest.json and checks git log for staleness."
argument-hint: ""
...
Si absent : "Aucun graphe construit. Lancer `/graph-build --java` pour démarrer."
